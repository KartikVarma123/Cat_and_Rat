...
function preload() {
   ...
   cat_Ani = loadAnimation("cat1.png");
   cat_Ani2 = loadAnimation("cat2.png","cat3.png");
   cat_Ani3 = loadAnimation("cat4.png");
   rat_Ani =  loadAnimation("mouse1.png");
   rat_Ani2 = loadAnimation("mouse2.png","mouse3.png");
   rat_Ani3 = loadAnimation("mouse4.png");
